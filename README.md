...
- Python (sockets, basic systems, scripting)
- Web stuff (HTML, CSS, JavaScript, PHP)
- Databases (SQL, MySQL, basic design)
- Android Studio + Firebase (school projects)
- Tools like VS Code, GitHub, Postman

---

#Right now
I’m still learning and improving my skills, especially around building better systems and understanding real-world development practices.
